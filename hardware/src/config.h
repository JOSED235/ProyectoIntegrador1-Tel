...
inline constexpr uint8_t BTN_PIN = 0;

inline constexpr uint8_t FSR_PIN =   34;


// SAMPLING


inline constexpr uint16_t SAMPLE_RATE_HZ =  100;

inline constexpr uint32_t SAMPLE_PERIOD_US = 1000000UL / SAMPLE_RATE_HZ;
